...
```bash
git clone https://github.com/DriftQuality/MailAccess-875.git
cd MailAccess-875
python setup.py
```
...
| `GITHUB_TOKEN` | `github_commits` | https://github.com/DriftQuality/MailAccess-875 | No (optional) |
...
<!-- Last updated: 2026-06-06 20:10:15 -->
